...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="loginmodal-container">
            ...
            <form>
                <input type="text" username="user" placeholder="Username">
                <input type="password" username="pass" placeholder="Password">
                <input type="submit" username="login" class="login loginmodal-submit" value="Login">
            </form>
        ...
        <form:form method="post" action="${contextPath}/insert?${_csrf.parameterName}=${_csrf.token}" modelAttribute="car" enctype="multipart/form-data">
            <table>
                ...
                <c:if test="${pageContext.request.userPrincipal.name != null}">
                    ...
                    <td>Title :</td>
                    <td><form:label id="user" path="username" required="required">${pageContext.request.userPrincipal.name}</form:label></td>
                ...
                <tr>
                    ...
                    <td><select id="region">
                        ...
                        <c:forEach var="regionList" items="${regionList}">
                            <option value="${regionList.id}">${regionList.username}</option>
                        </c:forEach>
                ...
                <td>
                    <%--<form method="POST" action="uploadMultipleFile" enctype="multipart/form-data">--%>
                        File1 to upload: <input type="file" name="file" multiple>
